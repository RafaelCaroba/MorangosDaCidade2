           ...
           public void InserirAdministrador()
            {
                ...
                string consulta = "INSERT INTO dbo.ADMINISTRADOR (IdUsuario, NOME,CPF,TELEFONE,EMAIL,DataNascimento,SENHA)" + " VALUES (@IdUsuario, @NOME, @CPF, @TELEFONE, @EMAIL, @DataNascimento, @SENHA)";
                ...
                using (SqlConnection conexao = new SqlConnection(stringDeConexao))
                {
                    ...
                    //comando.Parameters.AddWithValue("@IdAdmin", IdUsuario);
